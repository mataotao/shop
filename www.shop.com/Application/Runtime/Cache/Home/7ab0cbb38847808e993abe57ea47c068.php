                ...
                <form action="<?php echo U();?>" method="post" id='reg-form'>
                    <ul>
                        ...
                        <li class="checkcode">
                            ...
                            <span>看不清？<a href="javascript:;" onclick="change_img_captcha()">换一张</a></span><span
                                class="error"></span>
                        </li>

                        <li>
                            <label for="">&nbsp;</label>
                            <input type="checkbox" class="chb" checked="checked" name='agree'/> 我已阅读并同意《用户注册协议》<span
                                class="error"></span>
                        </li>
                        <li>
                            <label for="">&nbsp;</label>
...
<script>
    ...
    <script type="text/javascript" src="http://www.shop.com/Public/Home/ext/jquery-validate/dist/jquery.validate.js"></script>

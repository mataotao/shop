    ...
    <div class="mycart w990 mt10 bc">
        ...
        <table>
            ...
            <?php if(is_array($goods_info_list)): foreach($goods_info_list as $key=>$goods): ?><tr>
                    <td class="col1"><a
                            href="<?php echo U('Index/goods',['id'=>$goods['id']]);?>"><img
                            src="<?php echo ($goods["logo"]); ?>" alt=""/></a> <strong><a
                    ...
                    <td class="col4">
                        ...
                        <input type="text" name="amount" value="<?php echo ($goods["amount"]); ?>"
                               class="amount"/>
            ...
            <tfoot>
            <tr>
                <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?php echo ($total_price); ?></span></strong>
                </td>
            </tr>
            </tfoot>
        </table>
